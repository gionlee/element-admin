...
export default class Demo extends Vue {
    ...
    init = async ()=> {
        ...
        let height = el.offsetHeight - 100
        const graph = new G6.Graph({
            ...
            modes: {   //  图上行为模式的集合。 默认 null  详见https://g6.antv.vision/zh/docs/manual/middle/states/mode
                default:['drag-canvas', 'zoom-canvas']  
            },
            defaultNode: {   // 节点默认的属性，包括节点的一般属性和样式属性 默认为null
            },
            ...
            defaultEdge: {   // 边默认的属性，包括边的一般属性和样式属性。默认为null
                // 去掉全局配置的 style
                labelCfg: {
                // 边上的标签文本配置
            ...
            nodeStateStyles : {    // 节点在除默认状态外，其他状态下的样式属性。 默认为null
            }
        })
